...
local waterNormal = dxCreateTexture("water/normal.png", "dxt1")
local waterFoam = dxCreateTexture("water/foam.png", "dxt1")
local waterShader
local currentMinute, minuteStartTickCount, minuteEndTickCount = 0, 0, 0
local lowShader = dxCreateShader("water_low.fx", 0, 0, false, "world")-- Low quality shader (This rudimentary shader only enables Z-Writing for default GTA:SA water)
if lowShader then
