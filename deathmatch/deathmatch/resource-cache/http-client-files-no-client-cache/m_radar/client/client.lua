...
local vizSzin = tocolor(33, 33, 33,255)
local nagymap
...
function ujRadarRender()
	...
	for i,utvonal in ipairs(gpsPontok) do
		...
		if(ux and uy) then
			dxDrawLine ( ux, uy, n_x, n_y, tocolor(60, 189, 189, 255), 8 )
			ux, uy = n_x, n_y
		else
			ux, uy = n_x,n_y
		end
...
function dxCreateBorder(x,y,w,h,color)
	dxDrawRectangle(x-3,y-3,w+6,3,color)
	dxDrawRectangle(x-3,y,3,h,color)
	dxDrawRectangle(x-3,y+h,w+6,3,color)
	dxDrawRectangle(x+w,y-3,3,h+3,color)
end
...
function formDobozRajzolasa(x, y, sz, m, hszin, kszin, elore)
	dxDrawRectangle ( x, y+dobozS[4]/2, 1, m-dobozS[4], kszin or tocolor(60,63,63,255), elore)
	dxDrawRectangle ( x+sz-(dobozS[1]-dobozB[1]-1), y+dobozS[4]/2, 1, m-dobozS[4], kszin or tocolor(60,63,63,255), elore)
	dxDrawRectangle ( x+dobozS[4]/2, y, sz-dobozS[4], 1, kszin or tocolor(60,63,63,255), elore)
	dxDrawRectangle ( x+dobozS[4]/2, y+m-(dobozS[1]-dobozB[1]-1), sz-dobozS[4], 1, kszin or tocolor(60,63,63,255), elore)
