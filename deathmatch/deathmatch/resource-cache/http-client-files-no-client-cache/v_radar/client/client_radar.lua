...
MAP.pos = {x=36/zoom, y=sh-(275/zoom), w=400/zoom, h=251/zoom}
...
MAP.onRender = function()
	...
	if(getElementDimension(localPlayer) == 0 and getElementInterior(localPlayer) == 0)then
		...
		-- map outline
		dxDrawImage(MAP.pos.x, MAP.pos.y, MAP.pos.w, MAP.pos.h, SETTINGS.minimap_textures.outline, 0, 0, 0, tocolor(255, 255, 255, 255), false)
		--
		...
		dxDrawImage(MAP.pos.x, MAP.pos.y+(MAP.pos.h-47/zoom), MAP.pos.w, 46/zoom, SETTINGS.minimap_textures.rectangle, 0, 0, 0, tocolor(255, 255, 255, alpha), false)
		dxDrawText(text, MAP.pos.x+15/zoom, MAP.pos.y+(MAP.pos.h-46/zoom), MAP.pos.w, 46/zoom+MAP.pos.y+(MAP.pos.h-43/zoom), tocolor(200, 200, 200, alpha), 1, MAP.fonts[1], "left", "center", false)
